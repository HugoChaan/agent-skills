...
> **CRITICAL FIRST STEP:** Before doing ANY work, run `bash skills/shengwang-integration/scripts/fetch-docs.sh`
...
2. Start from [skills/shengwang-integration/SKILL.md](skills/shengwang-integration/SKILL.md) — it is the root entry point
...
- **FIRST ACTION on every session:** check if `skills/shengwang-integration/references/docs.txt` exists; if not, run `bash skills/shengwang-integration/scripts/fetch-docs.sh` before doing anything else
