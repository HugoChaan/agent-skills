...
3. Each sub-module has a `README.md` with its workflow: confirm credentials → fetch docs via MCP → generate code → validate
...
See [references/mcp-tools.md](skills/shengwang-integration/references/mcp-tools.md) for tool usage patterns.
